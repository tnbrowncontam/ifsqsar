...
fragmentlist = numpy.array([('[Nv3;H1&$(N-[#6!$(C=O)]),H0&$(N(-[#6!$(C=O)])-[#6!$(C=O)])]-[NH0v3]=O', 'Nitroso [-N-N=O]', 0.0),
                            ('[C;H3,H2]-[CH2]-[CH2]-[CH3]', 'Linear C4 terminal chain [CCC-CH3]', 0.0),
                            ...
                            ('O=[C,c;!$(C(O)[O,N,S])]-,:[O,o;$([#8]-,:[#6!$(C=O)])]', 'Ester [-C(=O)-O-C]', 0.0),
                            ('[Nv3;H2,H1&$(N-[P,#6;!$(C=O)]),H0&$(N(-[#6!$(C=O)])-[#6!$(C=O)])]-[C$(C-[#6])!$(C(-N)-[O,N,S])]=[S,O]', 'Amide [-C(=O)-N or -C(=S]-N]', 0.0),
                            ('c1[nX2]c[nX2]c[nX2]1', 'Triazine ring (symmetric)', 0.0),
                            ...
                            ('[Nv3!$(N-C=[O,S,N]);H2&$(N-C),H1&$(N(-C)-C)]', 'Aliphatic amine [-NH2  or  -NH-]', 0.0),
                            ('[Nv3!$(N-C=[O,S,N]);H2&$(N-c),H1&$(N(-c)-[#6])]', 'Aromatic amine [-NH2  or  -NH-]', 0.0),
                            ...
                            ('[nH0v3]1ccccc1', 'Pyridine ring', 0.0),
                            ...
                            ('[cH]1:[cH]:[cH]:[cH]:[cH]2:[cH]:1:[cH]:[cH]:[cH]:[cH]:2', 'Unsubstituted aromatic [3 or less rings): naphthalene', 0.0),
